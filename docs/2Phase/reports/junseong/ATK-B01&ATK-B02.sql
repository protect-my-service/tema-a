-- ATK-B01&ATK-B02: 결제 지연 / 중복 결제 Race Condition 테스트 데이터
-- k6: k6-test/atk-b01-b02.js
-- order_id/member_id 1~4000: 결제 가능한 PENDING 주문
-- B01 기본 범위: order_id 1~3000
-- B02 기본 대상: order_id 3900
...
SELECT setval('orders_id_seq', 4000);
SELECT setval('order_item_id_seq', 4000);
